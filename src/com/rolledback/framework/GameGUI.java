...
public class GameGUI extends JPanel {
	...
	public void fixComponents(int realHeight) {
		...
		this.setPreferredSize(new Dimension(this.getWidth(), realHeight));
	...
	public void setupCanvas() {
		...
		canvasPanel.setBorder(new TitledBorder(new LineBorder(Color.BLACK, 1), "Current Unit"));
